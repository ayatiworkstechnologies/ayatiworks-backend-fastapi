...
from app.schemas.organization import DepartmentCreate, DepartmentUpdate, DesignationCreate, DesignationUpdate
...
class DepartmentService:
    ...
    def update(self, department_id: int, data: DepartmentUpdate, updated_by: int = None) -> Optional[Department]:
        """Update a department."""
...
class DesignationService:
    ...
    def update(self, designation_id: int, data: DesignationUpdate, updated_by: int = None) -> Optional[Designation]:
