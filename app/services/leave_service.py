...
from app.models.leave import Holiday, Leave, LeaveBalance, LeaveType
from app.schemas.leave import LeaveApprovalRequest, LeaveCreate
...
class LeaveService:
    ...
    def get_balance(self, employee_id: int, leave_type_id: int, year: int) -> LeaveBalance | None:
    ...
    def approve_leave(self, leave_id: int, approver_id: int, data: LeaveApprovalRequest) -> Leave | None:
    ...
    def cancel_leave(self, leave_id: int, cancelled_by: int, reason: str) -> Leave | None:
...
class HolidayService:
    ...
    def get_by_id(self, holiday_id: int) -> Holiday | None:
        """Get holiday by ID."""
    ...
    def get_upcoming(self, company_id: int | None = None, limit: int = 5) -> list[Holiday]:
    ...
    def create(self, company_id: int | None, name: str, holiday_date: date,
